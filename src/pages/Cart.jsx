...
export default function Cart() {
  ...
  const { item, totalPrice } = useSelector(el => el.cartSlice)

  const amountItems = item.reduce((sum, item) => sum + item.count, 0)
    ...
    <div class="cart">
      <div class="cart__top">
        <h2 class="content__title"><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          Корзина</h2>
        <div class="cart__clear" onClick={onClearCart} >
      ...
      <div class="content__items">
        {item.map((el) => (
          <CartItem  el={el} key={el.id} id={el.id} title={el.title} price={el.price} imageUrl={el.imageUrl} sizes={el.sizes} types={el.types} count={el.count} />
      ...
      <div class="cart__bottom">
        <div class="cart__bottom-details">
          <span> Всего пицц: <b>{amountItems} шт.</b> </span>
